<div class="title-container align-items-center gap-2 d-flex">
	...
	<div data-component="composer/title" class="position-relative flex-1" style="min-width: 0;">
        ...
        <div class="form-check form-switch mt-2" component="composer/anonymous/toggle">
            <input class="form-check-input" type="checkbox" id="composer-anonymous-switch" name="anonymous" value="1">
			<label class="form-check-label" for="composer-anonymous-switch">[[topic:composer.make-anonymous]]</label>
		</div>
		{{{ else }}}
